...
import { allValues, mapValues } from './helpers/objectTools.js';
...
/**
 * @typedef { typeof import('./contractStarter.js').start } ContractStarterFn
 *
 * @typedef {{
 ...
 * }}}} [config]
 *
 * @typedef {Record<keyof import('./contractStarter.js').Prices, AmountData>} PriceConfig
 */
export const startContractStarter = async (
  ...
  /** @type {import('./contractStarter.js').Prices} */
